...
import { CrimeTimelinePageComponent } from './pages/crime-timeline-page/crime-timeline-page.component';
...
const routes: Routes = [
  ...
  { path: 'timeline/:crimeid', component: CrimeTimelinePageComponent }
];
